...
internal fun EditorScreen(
    ...
    val associationCmds = HashMap<String, String>(72)

    associationCmds[LanguageScope.C] = LanguageScope.C.substringAfter(".")
    associationCmds[LanguageScope.C] = LanguageScope.C.substringAfter(".")
    associationCmds[LanguageScope.CPP] = LanguageScope.CPP.substringAfter(".")
    associationCmds[LanguageScope.CPP] = LanguageScope.CPP.substringAfter(".")
    associationCmds[LanguageScope.CPP] = LanguageScope.CPP.substringAfter(".")
    associationCmds[LanguageScope.CSHARP] = LanguageScope.CSHARP.substringAfter(".")
    associationCmds[LanguageScope.CSS] = LanguageScope.CSS.substringAfter(".")
    associationCmds[LanguageScope.CSS] = LanguageScope.CSS.substringAfter(".")
    associationCmds[LanguageScope.DOCKER] = LanguageScope.DOCKER.substringAfter(".")
    associationCmds[LanguageScope.FORTRAN] = LanguageScope.FORTRAN.substringAfter(".")
    associationCmds[LanguageScope.FORTRAN] = LanguageScope.FORTRAN.substringAfter(".")
    associationCmds[LanguageScope.FORTRAN] = LanguageScope.FORTRAN.substringAfter(".")
    associationCmds[LanguageScope.FORTRAN] = LanguageScope.FORTRAN.substringAfter(".")
    associationCmds[LanguageScope.FORTRAN] = LanguageScope.FORTRAN.substringAfter(".")
    ...
    associationCmds[LanguageScope.FORTRAN] = LanguageScope.FORTRAN.substringAfter(".")
    associationCmds[LanguageScope.FORTRAN] = LanguageScope.FORTRAN.substringAfter(".")
    associationCmds[LanguageScope.GO] = LanguageScope.GO.substringAfter(".")
    associationCmds[LanguageScope.GROOVY] = LanguageScope.GROOVY.substringAfter(".")
    associationCmds[LanguageScope.GROOVY] = LanguageScope.GROOVY.substringAfter(".")
    associationCmds[LanguageScope.GROOVY] = LanguageScope.GROOVY.substringAfter(".")
    associationCmds[LanguageScope.GROOVY] = LanguageScope.GROOVY.substringAfter(".")
    associationCmds[LanguageScope.GROOVY] = LanguageScope.GROOVY.substringAfter(".")
    associationCmds[LanguageScope.HTML] = LanguageScope.HTML.substringAfter(".")
    associationCmds[LanguageScope.HTML] = LanguageScope.HTML.substringAfter(".")
    associationCmds[LanguageScope.INI] = LanguageScope.INI.substringAfter(".")
    associationCmds[LanguageScope.INI] = LanguageScope.INI.substringAfter(".")
    associationCmds[LanguageScope.INI] = LanguageScope.INI.substringAfter(".")
    associationCmds[LanguageScope.INI] = LanguageScope.INI.substringAfter(".")
    associationCmds[LanguageScope.JAVA] = LanguageScope.JAVA.substringAfter(".")
    associationCmds[LanguageScope.JAVASCRIPT] = LanguageScope.JAVASCRIPT.substringAfter(".")
    associationCmds[LanguageScope.JAVASCRIPT] = LanguageScope.JAVASCRIPT.substringAfter(".")
    associationCmds[LanguageScope.JAVASCRIPT] = LanguageScope.JAVASCRIPT.substringAfter(".")
    associationCmds[LanguageScope.JAVASCRIPT] = LanguageScope.JAVASCRIPT.substringAfter(".")
    associationCmds[LanguageScope.JSON] = LanguageScope.JSON.substringAfter(".")
    associationCmds[LanguageScope.JULIA] = LanguageScope.JULIA.substringAfter(".")
    associationCmds[LanguageScope.KOTLIN] = LanguageScope.KOTLIN.substringAfter(".")
    associationCmds[LanguageScope.KOTLIN] = LanguageScope.KOTLIN.substringAfter(".")
    associationCmds[LanguageScope.LATEX] = LanguageScope.LATEX.substringAfter(".")
    associationCmds[LanguageScope.LISP] = LanguageScope.LISP.substringAfter(".")
    associationCmds[LanguageScope.LISP] = LanguageScope.LISP.substringAfter(".")
    associationCmds[LanguageScope.LISP] = LanguageScope.LISP.substringAfter(".")
    associationCmds[LanguageScope.LISP] = LanguageScope.LISP.substringAfter(".")
    associationCmds[LanguageScope.LUA] = LanguageScope.LUA.substringAfter(".")
    associationCmds[LanguageScope.MAKE] = LanguageScope.MAKE.substringAfter(".")
    associationCmds[LanguageScope.MARKDOWN] = LanguageScope.MARKDOWN.substringAfter(".")
    associationCmds[LanguageScope.PHP] = LanguageScope.PHP.substringAfter(".")
    associationCmds[LanguageScope.PHP] = LanguageScope.PHP.substringAfter(".")
    associationCmds[LanguageScope.PHP] = LanguageScope.PHP.substringAfter(".")
    associationCmds[LanguageScope.PHP] = LanguageScope.PHP.substringAfter(".")
    associationCmds[LanguageScope.PHP] = LanguageScope.PHP.substringAfter(".")
    associationCmds[LanguageScope.PHP] = LanguageScope.PHP.substringAfter(".")
    associationCmds[LanguageScope.TEXT] = LanguageScope.TEXT.substringAfter(".")
    associationCmds[LanguageScope.TEXT] = LanguageScope.TEXT.substringAfter(".")
    associationCmds[LanguageScope.PYTHON] = LanguageScope.PYTHON.substringAfter(".")
    associationCmds[LanguageScope.PYTHON] = LanguageScope.PYTHON.substringAfter(".")
    associationCmds[LanguageScope.PYTHON] = LanguageScope.PYTHON.substringAfter(".")
    associationCmds[LanguageScope.RUBY] = LanguageScope.RUBY.substringAfter(".")
    associationCmds[LanguageScope.RUST] = LanguageScope.RUST.substringAfter(".")
    associationCmds[LanguageScope.SHELL] = LanguageScope.SHELL.substringAfter(".")
    associationCmds[LanguageScope.SHELL] = LanguageScope.SHELL.substringAfter(".")
    associationCmds[LanguageScope.SHELL] = LanguageScope.SHELL.substringAfter(".")
    associationCmds[LanguageScope.SHELL] = LanguageScope.SHELL.substringAfter(".")
    associationCmds[LanguageScope.SHELL] = LanguageScope.SHELL.substringAfter(".")
    associationCmds[LanguageScope.SHELL] = LanguageScope.SHELL.substringAfter(".")
    associationCmds[LanguageScope.SHELL] = LanguageScope.SHELL.substringAfter(".")
    associationCmds[LanguageScope.SMALI] = LanguageScope.SMALI.substringAfter(".")
    associationCmds[LanguageScope.SQL] = LanguageScope.SQL.substringAfter(".")
    associationCmds[LanguageScope.SQL] = LanguageScope.SQL.substringAfter(".")
    associationCmds[LanguageScope.SQL] = LanguageScope.SQL.substringAfter(".")
    associationCmds[LanguageScope.SQL] = LanguageScope.SQL.substringAfter(".")
    associationCmds[LanguageScope.TOML] = LanguageScope.TOML.substringAfter(".")
    associationCmds[LanguageScope.TYPESCRIPT] = LanguageScope.TYPESCRIPT.substringAfter(".")
    associationCmds[LanguageScope.TYPESCRIPT] = LanguageScope.TYPESCRIPT.substringAfter(".")
    associationCmds[LanguageScope.TYPESCRIPT] = LanguageScope.TYPESCRIPT.substringAfter(".")
    associationCmds[LanguageScope.TYPESCRIPT] = LanguageScope.TYPESCRIPT.substringAfter(".")
    associationCmds[LanguageScope.VISUALBASIC] = LanguageScope.VISUALBASIC.substringAfter(".")
    associationCmds[LanguageScope.VISUALBASIC] = LanguageScope.VISUALBASIC.substringAfter(".")
    associationCmds[LanguageScope.VISUALBASIC] = LanguageScope.VISUALBASIC.substringAfter(".")
    associationCmds[LanguageScope.XML] = LanguageScope.XML.substringAfter(".")
    associationCmds[LanguageScope.XML] = LanguageScope.XML.substringAfter(".")
    associationCmds[LanguageScope.XML] = LanguageScope.XML.substringAfter(".")
    associationCmds[LanguageScope.XML] = LanguageScope.XML.substringAfter(".")
    associationCmds[LanguageScope.XML] = LanguageScope.XML.substringAfter(".")
    associationCmds[LanguageScope.XML] = LanguageScope.XML.substringAfter(".")
    associationCmds[LanguageScope.YAML] = LanguageScope.YAML.substringAfter(".")
    associationCmds[LanguageScope.YAML] = LanguageScope.YAML.substringAfter(".")
            ...
            when (event) {
                ...
                is EditorViewEvent.CodeRunContract -> {
                    MaterialDialog(context).show {
                        ...
                        val bundle = Bundle()
                        bundle.putString("CODE_LANGUAGE", associationCmds[event.language])
